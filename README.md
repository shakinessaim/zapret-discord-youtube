...
**И БЕЙТЕ ПО КНОПКЕ ENTER ПОКА НЕ БУДЕТ ПРИГЛАШЕНИЯ ТЕРМИНАЛА**
...
После выбора конфигурации скрипт автоматически установит её и запустит zapret.
...
Вы можете дополнить список заблокированных сайтов, отредактировав файлы:

    list-general.txt — для конфигурации

> [!IMPORTANT]
> После изменения списка перезапустите zapret.
